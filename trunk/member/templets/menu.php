...
<div class="dedeLeft">
    <ul class="leftNav">
        <li class="icon article"><a href="../member/content_list.php?channelid=1" title="已发布的文章">已发布的文档</a></li>
		<li class="icon article"><a href="../member/article_add.php" title="发表新文章">发表新文档</a></li>
    ...
    <button class="button2 mTB10" onclick="location='../member/edit_baseinfo.php';">资料</button>
    <hr width="94%" class="dotted" />
    <div class="lineB"></div>
</div>